...
<body>
                ...
                <div class="navbar-nav mx-auto">
                    ...
                    <!-- <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 rounded-bottom border-0 shadow-sm m-0">
                            <a href="facility.html" class="dropdown-item">Wallyard concept hostel Facilities</a>
                           <a href="team.html" class="dropdown-item">Popular Teachers</a>
                            <a href="call-to-action.html" class="dropdown-item">Become A Teachers</a>
                            <a href="appointment.html" class="dropdown-item">Login</a>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <input type="text" class="form-control border-0" name="user" id="user" placeholder="Gurdian Name">
                                                <label for="gname">Email</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <input type="password" class="form-control border-0" name="pass" id="pass" placeholder="Gurdian Email">
                                                <label for="pass">Enter Old Password</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <input type="password" class="form-control border-0" name="pass1" id="pass1" placeholder="Gurdian Email">
                                       ...
                                       <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-4">
                                            <button class="btn btn-primary w-100 py-3" value="submit" type="submit">Submit</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <script>
        function validation() {
            ...
            var psd = document.f1.pass1.value;
            if (id.length == "" && ps.length == "" && psd.length == "") {
                alert("User Name and Password's fields are empty");
                return false;
            } else {
                if (id.length == "") {
