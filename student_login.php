                    ...
                    <div class="row g-0">
                        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                            <div class="h-100 d-flex flex-column justify-content-center p-5">
                                ...
                                <form name="f1" action="authentication_student.php" method="POST" onsubmit="return validation()">
                                    <div class="row g-3">
                                        <div class="col-12">
                                       ...
                                       <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-5">
                                            <a href="stu_change_pwd.php" class="btn btn-primary w-100 py-3"> Change password </a>
                                        </div>
                                    </div>
                                </form>
                            </div>
