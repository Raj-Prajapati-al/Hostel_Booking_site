...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5 py-lg-0">
        ...
        <!-- <img style='width:10%; height:100px; ' src="https://img.freepik.com/free-vector/editable-hotel-logo-vector-business-corporate-identity-hostel_53876-111553.jpg" alt="">
                    ...
                    <div class="col-md-6">
                        <div class="card-body">
                            <form name="f1" action="authentication_student.php" onsubmit="return validation()" method="POST">
                                ...
                                <p class='mt-3 mb-3'>
                                    <label class="form-label"> <a href="student_changepassword.php"> Change password </a></label>
                                </p>
                            </form>
                        </div>
                    </div>
